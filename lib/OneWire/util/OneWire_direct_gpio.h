...
// Lokal gepatchte Kopie (Original: paulstoffregen/OneWire 2.3.8):
// ESP32-C6 nutzt wie der C3 GPIO-Register als Union mit .val-Member,
// daher unten ueberall zum C3-Zweig hinzugefuegt (Original kannte nur C3
// und fiel sonst auf den "plain ESP32"-Zweig zurueck, der auf C6 nicht
// kompiliert, da GPIO.in dort kein einfacher uint32_t mehr ist).
